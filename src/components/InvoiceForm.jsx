...
import { clearInvoices, editSelectedInvoices } from "../redux/bulkInvoicesSlice";

const InvoiceForm = ({id, isBulk, updatedData, setUpdatedData}) => {
  ...
  useEffect(() => {
    ...
    ? getOneInvoice(currentId)
      ...
      // Update other fields in newFormData as needed based on currentId
      return newFormData;
    });
    // eslint-disable-next-line
  }, [currentId, params.id, isCopy, isBulk, isEdit, listSize]);
  ...
  const handleAddInvoice = () => {
    if (isEdit) {
      ...
      dispatch(editSelectedInvoices(updatedData))
